...
// db connectors
// var dbUri = 'mongodb://127.0.0.1:27017/lra2'; // local - dev
...
exports.userscollection	= conn.collection('users');
var userscollection	= conn.collection('users');

// insert documents to collection
exports.insertNauruArticle		= Q.nfbind(naurucollection.insert.bind(naurucollection));
// exports.insertPNGArticle			= Q.nbind(pngcollection.insert.bind(pngcollection));//, function() { pngcollection.createIndex({"views": -1}); });
...
exports.insertUser	= Q.nbind(userscollection.insert.bind(userscollection));
